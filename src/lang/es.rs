...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Export server configuration successfully", "Configuración de servidor exportado con éxito"),
        ...
        ("Hardware Codec", "Codec del hardware"),
        ("Adaptive Bitrate", "Tasa de bits"),
        ("ID Server", "ID server"),
        ("Relay Server", "Server relay"),
        ("API Server", "API del Servidor"),
        ("invalid_http", "Error en http. Debe comenzar con http:// o https://"),
        ...
        ("Local", "Local"),
        ("Remote", "Remoto"),
        ("Remote Computer", "Ordenador remoto"),
        ...
        ("This is irreversible!", "Atención, esto es irreversible!"),
        ("Deleting", "Borrando"),
        ("files", "archivos"),
        ("Waiting", "Esperando"),
        ("Finished", "Acabado"),
        ...
        ("Failed to connect to rendezvous server", "No se pudo conectar al servidor destino"),
        ...
        ("Click to upgrade", "Click para actualizar"),
        ("Click to download", "Click para descargar"),
        ("Click to update", "Click para refrescar"),
        ...
        ("agreement_tip", "Al iniciar la instalación, usted acepta los términos del acuerdo de licencia."),
        ...
        ("Allow using keyboard and mouse", "Permitir el uso del teclado y del mouse"),
        ("Allow using clipboard", "Permitir usar portapapeles"),
        ("Allow hearing sound", "Permitir escuchar sonido"),
        ("Allow file copy and paste", "Permitir copiar y pegar los archivos"),
        ("Connected", "Conectado"),
        ...
        ("Reboot required", "Se requiere reiniciar"),
        ...
        ("Unselect all tags", "Deseleccionar todas las etiquetas"),
        ...
        ("Help", "Ayuda"),
        ("Failed", "Error"),
        ("Succeeded", "Copmletado"),
        ("Someone turns on privacy mode, exit", "El modo incognito se activa al salir"),
        ("Unsupported", "No soportado"),
        ("Peer denied", "Par denegado"),
        ("Please install plugins", "Por favor, instale los plugins"),
        ("Peer exit", "Par salio"),
        ("Failed to turn off", "Error al apagar"),
        ("Turned off", "Apagado"),
        ("In privacy mode", "En modo de incognito"),
        ("Out privacy mode", "Fuera del modo de incognito"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Mantener RustDesk como Servicio en segundo plano"),
        ("Ignore Battery Optimizations", "Ignorar optimizacioens de bateria"),
        ("android_open_battery_optimizations_tip", "Consejo para optimizaciones de batería en Android"),
        ("Connection not allowed", "Conexión no permitida"),
        ("Legacy mode", "Modo heredado"),
        ("Map mode", "Modo de mapa"),
        ("Translate mode", "Modo de traducción"),
        ...
        ("Account", "Cuenta"),
        ("Theme", "Diseño"),
        ("Dark Theme", "Diseño oscuro"),
        ("Dark", "Oscuro"),
        ("Light", "Suave"),
        ("Follow System", "Seguir sistema"),
        ("Enable hardware codec", "Disponibiidad del hardware codec"),
        ("Unlock Security Settings", "Desbloquear configuracion de seguridad"),
        ("Enable Audio", "Activar Audio"),
        ("Temporary Password Length", "Longitud de contraseña temporal"),
        ("Unlock Network Settings", "Desbloquear condiguración de red"),
        ("Server", "Servidor"),
        ("Direct IP Access", "Acceso IP directo"),
        ("Proxy", "Proxy"),
        ("Port", "Puerto"),
        ("Apply", "Aplicar"),
        ("Disconnect all devices?", "¿Desconectar todos los dipositivos?"),
        ("Clear", "Limpiar todo"),
        ("Audio Input Device", "Dispositivo de entrada de audio"),
        ("Deny remote access", "Denegar acceso remoto"),
        ("Use IP Whitelisting", "Utilizar Lista de IP permitidas"),
        ("Network", "Red"),
        ("Enable RDP", "Habilitar RDP"),
        ("Pin menubar", "Pin barra de menú"),
        ("Unpin menubar", "Desanclar la barra de menú"),
        ("Recording", "Grabación"),
        ("Directory", "Directorio"),
        ("Automatically record incoming sessions", "Grabar automaticamente al iniciar las conexiones"),
        ("Change", "Cambiar"),
        ("Start session recording", "Comenzar la grabacion de la conexión"),
        ("Stop session recording", "Detener la grabacion de la conexión"),
        ("Enable Recording Session", "Habilitar la granacion de la conexión"),
        ("Allow recording session", "Permitir grabar la conexión"),
        ("Enable LAN Discovery", "Habilitar la detección de REDES"),
        ("Deny LAN Discovery", "Denegar la detección de REDES"),
        ...
        ("Other", "Otro"),
        ("Confirm before closing multiple tabs", "Confirmar antes de cerrar todas las pestañas"),
        ("Keyboard Settings", "Configuración del teclado"),
        ("Custom", "Editor"),
        ("Full Access", "Acceso comppleto"),
        ("Screen Share", "Compartir pantalla"),
        ("Wayland requires Ubuntu 21.04 or higher version.", "Wayland necesita disponer de Ubuntu 21.04 o una versión superior."),
        ...
        ("JumpLink", "View"),
        ("Please Select the screen to be shared(Operate on the peer side).", "Por favor seleccione la pantalla que se compartirá (Operar en el lado del compañero)."),
    ].iter().cloned().collect();
}

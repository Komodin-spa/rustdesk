...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Export server configuration successfully", "Configuración de servidor exportado satisfactoriamente"),
        ...
        ("Adaptive Bitrate", "Bitrate Adaptative"),
        ("ID Server", "ID server"),
        ...
        ("Account", "Cuenta"),
        ("Theme", "Estilo"),
        ("Dark Theme", "Estilo Oscuro"),
        ("Dark", "Oscuro"),
        ("Light", "Suave"),
        ("Follow System", "Seguimiento Sistema"),
        ("Enable hardware codec", "Habilitar Codec de hardware"),
        ("Unlock Security Settings", "Desbloquar las configuraciones de seguridad"),
        ("Enable Audio", "Audio activo"),
        ("Temporary Password Length", "Contraseña temporal"),
        ("Unlock Network Settings", "Desbloquear las configuraciones de redes"),
        ("Server", "Servidor"),
        ("Direct IP Access", "Acceso IP directa"),
        ("Proxy", "Proxy"),
        ("Port", "Puerto"),
        ("Apply", "Aplicar"),
        ("Disconnect all devices?", "¿Quiere desconectar todos los dispositivos?"),
        ("Clear", "Limpiar"),
        ("Audio Input Device", "Dispositivo entrada de audio"),
        ("Deny remote access", "Denegar acceso remoto"),
        ("Use IP Whitelisting", "Lista permitidas de IP"),
        ("Network", "Red"),
        ("Enable RDP", "Habiltiar RDP"),
        ("Pin menubar", "Pin barra de menú"),
        ("Unpin menubar", "Desbloquear barra de menú"),
        ("Recording", "Grabación"),
        ("Directory", "Directorio"),
        ("Automatically record incoming sessions", "Graba automáticamente las sesiones entrantes"),
        ("Change", "Cambiar"),
        ("Start session recording", "Iniciar grabación de la sesión"),
        ("Stop session recording", "Detener grabación de la sesión"),
        ("Enable Recording Session", "Habilitar grabacioón de la sesión"),
        ("Allow recording session", "Permitir grabar la sesión"),
        ...
        ("Other", "Otro"),
        ("Confirm before closing multiple tabs", "Confirmación antes de cerrar las multiples pestañas"),
        ("Keyboard Settings", "Configuraciones del teclado"),
        ("Custom", "Editar"),
